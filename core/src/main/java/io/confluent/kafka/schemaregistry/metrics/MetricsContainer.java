...
public class MetricsContainer {
  ...
  public static final String METRIC_NAME_ASSOCIATION_BATCH_GET_BATCH_SIZE =
      "association-batch-get-batch-size";
  ...
  public static final String METRIC_NAME_ASSOCIATION_BATCH_MUTATE_CREATE_SINGLE_COUNT =
      "association-batch-mutate-create-single-count";
  public static final String METRIC_NAME_ASSOCIATION_BATCH_MUTATE_CREATE_MULTI_COUNT =
      "association-batch-mutate-create-multi-count";
  public static final String METRIC_NAME_ASSOCIATION_BATCH_MUTATE_CREATE_BATCH_SIZE =
      "association-batch-mutate-create-batch-size";
  public static final String METRIC_NAME_ASSOCIATION_BATCH_MUTATE_UPSERT_COUNT =
  ...
  private final SchemaRegistryMetric associationBatchGetBatchSize;
  ...
  private final SchemaRegistryMetric associationBatchMutateCreateSingle;
  private final SchemaRegistryMetric associationBatchMutateCreateMulti;
  ...
  public MetricsContainer(SchemaRegistryConfig config, String kafkaClusterId) {
    ...
    this.associationBatchGetBatchSize = createMetric(METRIC_NAME_ASSOCIATION_BATCH_GET_BATCH_SIZE,
            "Number of lookups in the most recent batchGet call", new Value());
    ...
    this.associationBatchMutateCreateSingle = createMetric(
            METRIC_NAME_ASSOCIATION_BATCH_MUTATE_CREATE_SINGLE_COUNT,
            "Number of single-item create runs within batchMutate calls", new CumulativeCount());
    this.associationBatchMutateCreateMulti = createMetric(
            METRIC_NAME_ASSOCIATION_BATCH_MUTATE_CREATE_MULTI_COUNT,
            "Number of multi-item create runs within batchMutate calls", new CumulativeCount());
    this.associationBatchMutateCreateBatchSize = createMetric(
            METRIC_NAME_ASSOCIATION_BATCH_MUTATE_CREATE_BATCH_SIZE,
            "Size (item count) of the most recent create run within batchMutate calls",
            new Value());
    this.associationBatchMutateUpsert = createMetric(
            METRIC_NAME_ASSOCIATION_BATCH_MUTATE_UPSERT_COUNT,
            "Number of upsert runs within batchMutate calls", new CumulativeCount());
  ...
  public SchemaRegistryMetric getAssociationBatchGetBatchSize() {
    return associationBatchGetBatchSize;
  }
  ...
  public SchemaRegistryMetric getAssociationBatchMutateCreateSingle() {
    return associationBatchMutateCreateSingle;
  }

  public SchemaRegistryMetric getAssociationBatchMutateCreateMulti() {
    return associationBatchMutateCreateMulti;
  }

  public SchemaRegistryMetric getAssociationBatchMutateCreateBatchSize() {
    return associationBatchMutateCreateBatchSize;
  }

  public SchemaRegistryMetric getAssociationBatchMutateUpsert() {
    return associationBatchMutateUpsert;
  }
