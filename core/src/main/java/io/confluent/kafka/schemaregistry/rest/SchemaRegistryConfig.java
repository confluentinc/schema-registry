...
public class SchemaRegistryConfig extends RestConfig {
  ...
  /**
   * <code>schema.referenced.by.search.default.limit</code>
   */
  public static final String SCHEMA_REFERENCED_BY_SEARCH_DEFAULT_LIMIT_CONFIG =
          "schema.referenced.by.search.default.limit";
  public static final int SCHEMA_REFERENCED_BY_SEARCH_DEFAULT_LIMIT = Integer.MAX_VALUE;
  /**
   * <code>schema.referenced.by.search.max.limit</code>
   */
  public static final String SCHEMA_REFERENCED_BY_SEARCH_MAX_LIMIT_CONFIG =
