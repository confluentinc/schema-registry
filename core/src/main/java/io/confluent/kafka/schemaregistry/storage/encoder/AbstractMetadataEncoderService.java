...
public abstract class AbstractMetadataEncoderService implements MetadataEncoderService {

  private static final Logger log = LoggerFactory.getLogger(AbstractMetadataEncoderService.class);
  ...
  public AbstractMetadataEncoderService(SchemaRegistry schemaRegistry) {
