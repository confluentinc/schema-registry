...
public class Difference {
  public enum Type {
    MESSAGE_ADDED, MESSAGE_REMOVED, ENUM_ADDED, ENUM_REMOVED, ENUM_CONST_ADDED, ENUM_CONST_CHANGED,
    ENUM_CONST_REMOVED, FIELD_ADDED, FIELD_REMOVED, FIELD_NAME_CHANGED, FIELD_KIND_CHANGED,
    FIELD_SCALAR_KIND_CHANGED, FIELD_NAMED_TYPE_CHANGED, ONEOF_ADDED, ONEOF_REMOVED,
