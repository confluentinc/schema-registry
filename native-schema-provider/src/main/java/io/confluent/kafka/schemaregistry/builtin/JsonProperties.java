...
import io.confluent.kafka.schemaregistry.builtin.utils.internal.Accessor.JsonPropertiesAccessor;
...
/**
 * Base class for objects that have JSON-valued properties. Avro and JSON values are represented in
 * Java using the following mapping:
 *
 * <table>
 * <th>
 * <td>Avro type</td>
...
public class JsonProperties {
  ...
  /**
   * Returns the value of the named property in this schema. Returns <tt>null</tt> if there is no
  ...
  public void forEachProperty(BiConsumer<String, Object> consumer) {
    for (Entry<String, JsonNode> entry : this.props.entrySet()) {
