    ...
    public void shouldQueryWindowKeyWithHeaders() throws Exception {
        ...
        try {
            try (KafkaProducer<GenericRecord, GenericRecord> producer =
                ...
                sendAndCapture(producer, new ProducerRecord<>(input, null, w0, createKey("sensor-1"), createValue(0)));
    ...
    public void shouldQuerySessionByKeyWithHeaders() throws Exception {
        ...
        try {
            try (KafkaProducer<GenericRecord, GenericRecord> producer =
                ...
                // record folded in.
                sendAndCapture(producer, new ProducerRecord<>(input, null, base, createKey("sensor-1"), createValue(1)));
