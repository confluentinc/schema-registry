...
public class AliCloudFieldEncryptionServiceLoaderTest extends FieldEncryptionServiceLoaderTest {

  public AliCloudFieldEncryptionServiceLoaderTest() throws Exception {
    super();
  }
  ...
  protected EncryptionProperties getFieldEncryptionProperties(
    ...
    return new AliCloudEncryptionProperties(ImmutableList.of(DEFAULT_NAME), ruleExecutor);
  }
}
