...
public class AvroDataTest {
  ...
  @Test
  public void testToConnectDecimalWithConnectName() {
    org.apache.avro.Schema avroSchema = org.apache.avro.SchemaBuilder.builder().bytesType();
  ...
  @Test
  public void testToConnectDecimalWithAvroLogicalType() {
    org.apache.avro.Schema avroSchema2 = org.apache.avro.SchemaBuilder.builder().bytesType();
    avroSchema2.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
    avroSchema2.addProp("scale", "2");
    new LogicalType("decimal").addToSchema(avroSchema2);
    assertEquals(new SchemaAndValue(Decimal.schema(2), TEST_DECIMAL),
                 avroData.toConnectData(avroSchema2, TEST_DECIMAL_BYTES));
  }

  @Test
  public void testToConnectDateWithConnectName() {
    org.apache.avro.Schema avroSchema = org.apache.avro.SchemaBuilder.builder().intType();
    avroSchema.addProp("connect.name", "org.apache.kafka.connect.data.Date");
    avroSchema.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
  ...
  @Test
  public void testToConnectDateWithAvroLogicalType() {
    org.apache.avro.Schema avroSchema2 = org.apache.avro.SchemaBuilder.builder().intType();
    avroSchema2.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
    new LogicalType("date").addToSchema(avroSchema2);
    assertEquals(new SchemaAndValue(Date.SCHEMA, EPOCH_PLUS_TEN_THOUSAND_DAYS.getTime()),
                 avroData.toConnectData(avroSchema2, 10000));
  }

  @Test
  public void testToConnectTimeWithConnectName() {
    org.apache.avro.Schema avroSchema = org.apache.avro.SchemaBuilder.builder().intType();
    avroSchema.addProp("connect.name", "org.apache.kafka.connect.data.Time");
    avroSchema.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
  ...
  @Test
  public void testToConnectTimeWithAvroLogicalType() {
    org.apache.avro.Schema avroSchema2 = org.apache.avro.SchemaBuilder.builder().intType();
    avroSchema2.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
    new LogicalType("time-millis").addToSchema(avroSchema2);
    assertEquals(new SchemaAndValue(Time.SCHEMA, EPOCH_PLUS_TEN_THOUSAND_MILLIS.getTime()),
                 avroData.toConnectData(avroSchema2, 10000));
  }

  @Test
  public void testToConnectTimestampWithConnectName() {
    org.apache.avro.Schema avroSchema = org.apache.avro.SchemaBuilder.builder().longType();
    avroSchema.addProp("connect.name", "org.apache.kafka.connect.data.Timestamp");
    avroSchema.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
    java.util.Date date = new java.util.Date();
  ...
  @Test
  public void testToConnectTimestampWithAvroLogicalType() {
    org.apache.avro.Schema avroSchema2 = org.apache.avro.SchemaBuilder.builder().longType();
    avroSchema2.addProp("connect.version", JsonNodeFactory.instance.numberNode(1));
    new LogicalType("timestamp-millis").addToSchema(avroSchema2);
    java.util.Date date = new java.util.Date();
    assertEquals(new SchemaAndValue(Timestamp.SCHEMA, date),
                 avroData.toConnectData(avroSchema2, date.getTime()));
  }
