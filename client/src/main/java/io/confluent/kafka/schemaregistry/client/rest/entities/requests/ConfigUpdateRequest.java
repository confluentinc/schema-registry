...
public class ConfigUpdateRequest {
  ...
  public ConfigUpdateRequest(Config config) {
    ...
    validateNewSchemas(config.isValidateNewSchemas());
  ...
  @JsonProperty("validateNewSchemas")
  public void validateNewSchemas(Optional<Boolean> validateNewSchemas) {
    this.validateNewSchemas = validateNewSchemas;
  }

  @JsonIgnore
  public void validateNewSchemas(Boolean validateNewSchemas) {
