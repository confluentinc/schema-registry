...
public class SubjectVersion implements Comparable<SubjectVersion> {
  ...
  @io.swagger.v3.oas.annotations.media.Schema(description = Schema.SUBJECT_DESC, example = Schema.SUBJECT_EXAMPLE)
  ...
  @io.swagger.v3.oas.annotations.media.Schema(description = Schema.VERSION_DESC, example = Schema.VERSION_EXAMPLE)
