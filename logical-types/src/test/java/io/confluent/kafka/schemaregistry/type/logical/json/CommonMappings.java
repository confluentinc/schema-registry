...
/**
 * Type-mapping matrix for JSON Schema. Each entry is a single-field struct
 * paired with the field's expected logical Schema after round-trip. Drives
 * round-trip equality so any new primitive type lights up a missing-coverage
 * test until added here.
 */
