 ...
 * "topic.cluster.id", then its value will be passed as the resource namespace;
...
public class AssociatedNameStrategy implements SubjectNameStrategy {
  ...
  public static final String TOPIC_CLUSTER_ID = "topic.cluster.id";
  ...
  private String topicClusterId;
  private boolean skipTopicNameStrategyFallback;
  private LoadingCache<CacheKey, String> subjectNameCache;

  @Override
  public void configure(Map<String, ?> configs) {
    Object topicClusterIdConfig = configs.get(TOPIC_CLUSTER_ID);
    if (topicClusterIdConfig != null) {
      this.topicClusterId = topicClusterIdConfig.toString();
    }
  ...
  private String loadSubjectName(String topic, boolean isKey) 
    ...
    List<Association> associations = client.getAssociationsByResourceName(
        topic,
        topicClusterId != null ? topicClusterId : NAMESPACE_WILDCARD,
        "topic",
