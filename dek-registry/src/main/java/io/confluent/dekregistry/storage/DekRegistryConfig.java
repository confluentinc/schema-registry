...
public class DekRegistryConfig extends SchemaRegistryConfig {
  ...
  protected static final String DEK_REGISTRY_VERSION_SEARCH_DEFAULT_LIMIT_CONFIG =
          "kek.registry.search.default.limit";
  protected static final int DEK_REGISTRY_VERSION_SEARCH_DEFAULT_LIMIT_DEFAULT = Integer.MAX_VALUE;

  protected static final String DEK_REGISTRY_VERSION_SEARCH_MAX_LIMIT_CONFIG =
          "kek.registry.search.max.limit";
  protected static final int DEK_REGISTRY_VERSION_SEARCH_MAX_LIMIT_DEFAULT = Integer.MAX_VALUE;
  ...
  protected static final String DEK_REGISTRY_VERSION_SEARCH_DEFAULT_LIMIT_DOC =
          "The default limit for dek version searches.";
  protected static final String DEK_REGISTRY_VERSION_SEARCH_MAX_LIMIT_DOC =
  ...
  static {
    serverConfig = baseSchemaRegistryConfigDef()
        ...
        .define(DEK_REGISTRY_VERSION_SEARCH_DEFAULT_LIMIT_CONFIG, INT,
                DEK_REGISTRY_VERSION_SEARCH_DEFAULT_LIMIT_DEFAULT,
                LOW, DEK_REGISTRY_VERSION_SEARCH_DEFAULT_LIMIT_DOC)
        .define(DEK_REGISTRY_VERSION_SEARCH_MAX_LIMIT_CONFIG, INT, DEK_REGISTRY_VERSION_SEARCH_MAX_LIMIT_DEFAULT,
                LOW, DEK_REGISTRY_VERSION_SEARCH_MAX_LIMIT_DOC)
