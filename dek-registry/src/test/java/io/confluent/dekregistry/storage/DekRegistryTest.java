...
public class DekRegistryTest extends ClusterTestHarness {
    ...
    public void setUp() throws Exception {
        ...
        String encryptedKeyMaterial1 = Base64.getEncoder().encodeToString(encryptedDek);
        CreateDekRequest dekRequest1 = CreateDekRequest.fromJson(
                String.format(
                        "{\"subject\": \"subject1\", \"version\": \"2\", \"algorithm\": \"AES256_GCM\", \"encryptedKeyMaterial\": \"%s\", \"deleted\": true}",
                        encryptedKeyMaterial1)
        );
        dekRegistry.createDek(kek.getName(), dekRequest1);
    }
    ...
    public void testGetKekNames() throws Exception {
        ...
        // Test get by subject prefix without Dek.
        ...
        String encryptedKeyMaterial2 = Base64.getEncoder().encodeToString(encryptedDek);
        CreateDekRequest dekRequest2 = CreateDekRequest.fromJson(
                String.format(
                        "{\"subject\": \"subject2\", \"version\": \"2\", \"algorithm\": \"AES256_GCM\", \"encryptedKeyMaterial\": \"%s\", \"deleted\": false}",
                        encryptedKeyMaterial2)
        );
        dekRegistry.createDek(kek2.getName(), dekRequest2);
