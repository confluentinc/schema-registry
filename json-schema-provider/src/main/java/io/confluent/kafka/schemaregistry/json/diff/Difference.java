...
public class Difference {
  public enum Type {
    ...
    UNEVALUATED_PROPERTIES_ADDED, UNEVALUATED_PROPERTIES_REMOVED,
    UNEVALUATED_PROPERTIES_EXTENDED, UNEVALUATED_PROPERTIES_NARROWED,

    MAX_ITEMS_ADDED, MAX_ITEMS_REMOVED, MAX_ITEMS_INCREASED, MAX_ITEMS_DECREASED, MIN_ITEMS_ADDED,
    MIN_ITEMS_REMOVED, MIN_ITEMS_INCREASED, MIN_ITEMS_DECREASED,
    MAX_CONTAINS_ADDED, MAX_CONTAINS_REMOVED, MAX_CONTAINS_INCREASED, MAX_CONTAINS_DECREASED,
    MIN_CONTAINS_ADDED, MIN_CONTAINS_REMOVED, MIN_CONTAINS_INCREASED, MIN_CONTAINS_DECREASED,
    UNIQUE_ITEMS_ADDED,
    UNIQUE_ITEMS_REMOVED, ADDITIONAL_ITEMS_ADDED, ADDITIONAL_ITEMS_REMOVED,
    ADDITIONAL_ITEMS_EXTENDED, ADDITIONAL_ITEMS_NARROWED,
    UNEVALUATED_ITEMS_ADDED, UNEVALUATED_ITEMS_REMOVED,
    UNEVALUATED_ITEMS_EXTENDED, UNEVALUATED_ITEMS_NARROWED,
  ...
  Set<Type> keywordAddedOrRemoved = new HashSet<>(Arrays.asList(Type.MAXIMUM_ADDED,
      ...
      Type.MIN_ITEMS_ADDED, Type.MAX_CONTAINS_ADDED, Type.MIN_CONTAINS_ADDED,
      Type.UNIQUE_ITEMS_ADDED, Type.ADDITIONAL_ITEMS_REMOVED,
      Type.ADDITIONAL_PROPERTIES_REMOVED, Type.UNEVALUATED_PROPERTIES_REMOVED,
      Type.UNEVALUATED_ITEMS_REMOVED));
  Set<Type> valueIncreased = new HashSet<>(Arrays.asList(Type.MIN_LENGTH_INCREASED,
      ...
      Type.MIN_CONTAINS_INCREASED));
  Set<Type> valueDecreased = new HashSet<>(Arrays.asList(Type.MAX_LENGTH_DECREASED,
      Type.MAXIMUM_DECREASED, Type.MAX_ITEMS_DECREASED, Type.MAX_CONTAINS_DECREASED,
  ...
  Set<Type> typeNarrowed = new HashSet<>(Arrays.asList(
      ...
      Type.ADDITIONAL_PROPERTIES_NARROWED, Type.UNEVALUATED_PROPERTIES_NARROWED,
      Type.UNEVALUATED_ITEMS_NARROWED));
  ...
  Set<Type> propertyOrItemAddedToOpen = new HashSet<>(Arrays.asList(
      Type.PROPERTY_ADDED_TO_OPEN_CONTENT_MODEL,
